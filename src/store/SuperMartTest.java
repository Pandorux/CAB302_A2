...
*/
	    ...
	    public void Test5()//green
	    {
				 ...
				 String[] Product_info = new String[7];//a array of values that protane to a object
			 	 ...
			 	 store_test_cases(Potato, 500, 50, 100, hell its self, 50, 0);
	    ...
	    public void Test6()//green
	    {
	    	...
	    	assertEquals("Potato, 500, 50, 100, hell its self, 50, 0", SuperMart.Store_Object("Potato", 500, 50, 100, "hell its self", 50, 0));
			 
	    }
	    
	    
	    private void store_test_cases(String name,Integer Quantity,Double Cost,Double sell_price, String Distrobution_point, integer reorder_amm, Double Temprature = null)//temp is not nessasary but if it is not input its null
	    {
